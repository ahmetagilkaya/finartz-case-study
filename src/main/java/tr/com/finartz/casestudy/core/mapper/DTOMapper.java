package tr.com.finartz.casestudy.core.mapper;
...
public class DTOMapper extends RequestResponseBodyMethodProcessor {
    ...
    public boolean supportsParameter(MethodParameter parameter) {
        return parameter.hasParameterAnnotation(tr.com.finartz.casestudy.core.mapper.DTO.class);
    }
    ...
    protected Object readWithMessageConverters(HttpInputMessage inputMessage, MethodParameter parameter, Type targetType) throws IOException, HttpMediaTypeNotSupportedException, HttpMessageNotReadableException {
        for (Annotation ann : parameter.getParameterAnnotations()) {
            tr.com.finartz.casestudy.core.mapper.DTO dtoType = AnnotationUtils.getAnnotation(ann, tr.com.finartz.casestudy.core.mapper.DTO.class);
            if (dtoType != null) {
